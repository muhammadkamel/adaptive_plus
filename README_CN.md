...
[更新日志](https://github.com/OpenFlutter/screen_adaptive_plus/blob/master/CHANGELOG.md)
...
[小部件测试](https://github.com/OpenFlutter/screen_adaptive_plus/issues/115)

### 使用示例:

[示例演示](https://github.com/OpenFlutter/screen_adaptive_plus/blob/master/example/lib/main_zh.dart)
