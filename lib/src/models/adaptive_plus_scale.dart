...
@immutable
class AdaptivePlusScale extends Equatable {
  final double fontScale;
  final double widthScale;
  final double heightScale;
  final double paddingScale;

  const AdaptivePlusScale({
    double? fontScale,
    double? widthScale,
    double? heightScale,
    double? paddingScale,
       ...
       paddingScale = paddingScale == null || paddingScale <= 0
           ? 1
           : paddingScale;

  @override
  List<Object?> get props => [fontScale, widthScale, heightScale, paddingScale];
}
