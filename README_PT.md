...
[README of English](https://github.com/OpenFlutter/screen_adaptive_plus/blob/master/README.md)

[github](https://github.com/OpenFlutter/screen_adaptive_plus)

[Histórico de atualizações](https://github.com/OpenFlutter/screen_adaptive_plus/blob/master/CHANGELOG.md)
...
dependencies:
  ...
  screen_adaptive_plus: ^{latest version}
```
...
[widget test](https://github.com/OpenFlutter/screen_adaptive_plus/issues/115)

### Exemplo:

[Demonstração](https://github.com/OpenFlutter/screen_adaptive_plus/blob/master/example/lib/main.dart)
